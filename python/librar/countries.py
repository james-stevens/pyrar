...
COUNTRIES = [["US", "United States of America"], ["UK", "United Kingdom"], ["AF", "Afghanistan"], ["AL", "Albania"],
             ["DZ", "Algeria"], ["AS", "American Samoa"], ["AD", "Andorra"], ["AO", "Angola"], ["AI", "Anguilla"],
             ["AQ", "Antarctica"], ["AG", "Antigua and Barbuda"], ["AR", "Argentina"], ["AM", "Armenia"],
             ["AW", "Aruba"], ["AU", "Australia"], ["AT", "Austria"], ["AX", "Åland Islands"], ["AZ", "Azerbaijan"],
             ...
             ["CY", "Cyprus"], ["CZ", "Czech Republic"], ["CI", "Côte d'Ivoire"], ["DK", "Denmark"],
             ...
             ["PR", "Puerto Rico"], ["QA", "Qatar"], ["RO", "Romania"], ["RU", "Russian Federation"], ["RW", "Rwanda"],
...
BY_COUNTRY = {i[0]: i[1] for i in COUNTRIES}
