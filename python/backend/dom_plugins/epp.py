...
def domain_update_flags(bke_job, dom):
    ...
    log(f"DEBUG: domain_update_flags: {json.dumps(update_xml,indnt=0)}")  # CODE - remove this
...
def domain_update_from_db(bke_job, dom):
    ...
    log(f"DEBUG: domain_update_from_db: {json.dumps(update_xml,indnt=0)}")  # CODE - remove this
